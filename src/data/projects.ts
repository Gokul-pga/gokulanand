export const projects = [
      ...
      },
    {
      ...
      title: "BloomWear",
      description:
        "Modern fashion catalogue website built from Figma designs with pixel-perfect responsiveness, smooth Framer Motion animations, interactive forms, and lead generation workflows.",
      image: "/projects/Bloomwear.png",
      tech: [
        "Next.js",
        "Tailwind CSS",
        "Framer Motion",
        "Responsive Design",
      ],  liveUrl: "https://aquamarine-tiger-999537.hostingersite.com/BloomWear/Home",
